...
import "./ss-by-browser.js";
import "./ss-by-route.js";
...
class SSDailySummary extends PolymerElement {
  ...
  connectedCallback() {
    super.connectedCallback(); //  var template = this.shadowRoot.this.querySelector()
  }
  ...
  static get properties() {
    return {
      ...
      model: {
        ...
        value: {
          user: {
            content: 'errors by user'
          },
          browser: {
            content: 'errors sorted by browser'
          },
          route: {
            content: 'errors sorted by route'
          }
        }
      }
    };
