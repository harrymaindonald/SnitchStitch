    ...
    var lineChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: ['rgba(0,138,230, 0.05)'],
          ...
          backgroundColor: ['rgba(18, 147, 28, 0.05)'],
          borderColor: ['rgba(18, 147, 28,1)'],
          borderWidth: 2
        }, {
          label: 'Actively',
          data: [{
          ...
          backgroundColor: ['rgba(133, 38, 117, 0.05)'],
          borderColor: ['rgba(133, 38, 117,1)'],
          borderWidth: 2
        }]
      },
      options: {
