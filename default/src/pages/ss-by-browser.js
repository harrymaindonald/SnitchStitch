...
class SSBybrowser extends PolymerElement {
  static get template() {
    return html`
...
<div class="wrapper">
      <div class="card">
       <h1>Errors By Browser</h1>
       <ss-sort-by-project></ss-sort-by-project>
      </div>
      <div class="card table-card">
          <ss-by-browser-chart></ss-by-browser-chart>
      </div>
      </div>
    `;
  }
...
window.customElements.define('ss-by-browser', SSBybrowser);